...
> **Cansat-Rocket Thailand × UNISEC Thailand:** Team Leader & Core Developer (2023–2024), then **[Technical Mentor](https://www.unisec-thailand.org/activity/thailand-cansat-rocket-competition-2025)** (2025–2026). Developed firmware for a Cansat and ground station using **ESP32** and **LoRa**, and mentored national finalists across software, firmware, and hardware integration. Won the **National Aerodynamic Award** (2023) and an Honorable Mention (2024).
...
**Data & Intelligence**
`Point Cloud & 3D Mesh Processing` `Real-Time Dashboards`

**Control & Signal**
`PID / Kalman Filter` `System Identification` `Cascade Control`
