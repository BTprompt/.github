...
## 💡 โปรเจกต์ที่นำเสนอ (Hackathon Project)
...
| Profile | Contact Information | Role | Tech Stack | Portfolio |
| :---: | :--- | :---: | :--- | :---: |
| <a href="https://github.com/Peaxtt"><img src="https://github.com/Peaxtt.png" width="60px;" alt="Bhirabhat Klomjit"/><br /><sub><b>Bhirabhat K.</b></sub></a> | 📧 bhirabhat.klom@mail.kmutt.ac.th<br>🐙 [@Peaxtt](https://github.com/Peaxtt) | Null | `ROS 2` `STM32` `React`<br>`Supabase` `MATLAB/Simulink` `Python` | [![View](https://img.shields.io/badge/View_Portfolio-238636?style=for-the-badge)](portfolio-bhirabhat.md) |
| <a href="https://github.com/Pond141205"><img src="https://github.com/Pond141205.png" width="60px;" alt="Theeranon Thummachotvarasiri"/><br /><sub><b>Theeranon T.</b></sub></a> | 📧 theeranon.thum@mail.kmutt.ac.th<br>🐙 [@Pond141205](https://github.com/Pond141205) | Full-Stack Hardware & Systems Engineer | `STM32` `ESP32` `LoRaWAN` `Point Cloud/3D Mesh` `PID/Kalman` | [![View](https://img.shields.io/badge/View_Portfolio-238636?style=for-the-badge)](portfolio-theeranon.md) |
...
| <img src="assets/warakorn/avatar-warakorn.jpg" width="60px" style="border-radius:50%;" alt="Warakorn Saewu"/><br /><sub><b>Warakorn S.</b></sub> | 📧 warkorn.saew@kmutt.ac.th | Electronics & Embedded Systems Engineer | `STM32` `TypeScript` `React` `Bun` `MySQL` `Tailwind CSS` | [![View](https://img.shields.io/badge/View_Portfolio-238636?style=for-the-badge)](portfolio-warakorn.md) |
